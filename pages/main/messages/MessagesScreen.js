...
const handleSendMessage = ()=>{
	...
	if(toWalletAddress){
		console.log("chats?.find((chat)=>chat?.name?.toLowerCase() == toWalletAddress?.toLowerCase())",chats?.find((chat)=>chat?.name?.toLowerCase() == toWalletAddress?.toLowerCase()))
...
const styles = StyleSheet.create({
	...
	titleBg:{flex:1, paddingHorizontal:16, flexDirection:"row",  maxHeight:30, justifyContent:"center", alignItems:"center", marginBottom:10},
